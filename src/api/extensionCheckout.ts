...
const row = z.object({ rentalId: id, productNo: z.string().nullable(), title: z.string().nullable(),
...
export function createExtensionCheckoutApi(client: ApiClient, organizationId: string) {
  ...
  return {
    offers: () => client.request('/api/v1/my/rentals/extension-offers', z.object({ id, rentalId: id, productNo: z.string(), title: z.string(),
