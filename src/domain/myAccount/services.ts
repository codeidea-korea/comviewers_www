...
export const accountManagerSchema = z.object({ id: z.string(), managerId: z.string(), name: z.string(), loginId: z.string(), assignedRcpcIds: z.array(z.string()), assignmentHistory: z.array(z.object({ rcpcId: z.string(), action: z.enum(['assigned', 'unassigned']), at: z.string() })).default([]), memo: z.string(), status: z.string(), permissionGroupId: z.number().int().positive().safe().nullable().optional(), permissionGroupName: z.string().nullable().optional() })
